...
from cvec_circus.py3compat import bytestring, string_types, quote
from cvec_circus.sockets import CircusSocket
from cvec_circus.util import (get_info, to_uid, to_gid, debuglog, get_working_dir,
    ...
    def _get_sockets_fds(self):
        ...
        if self.watcher is not None and self.watcher.sockets is not None:
            ...
            for sn, s in reuseport_sockets:
                ...
                if 'cvec_circus.sockets.%s' % sn in self.watcher.cmd:
