...
from cvec_circus.exc import CallError, ArgumentError
from cvec_circus.util import DEFAULT_ENDPOINT_SUB, DEFAULT_ENDPOINT_DEALER


USAGE = 'cvec_circusctl [options] command [args]'
VERSION = 'cvec_circusctl ' + __version__
TIMEOUT_MSG = """\
