...
from cvec_circus.sockets import CircusSocket
from cvec_circus.tests.support import TestCase, EasyTestSuite, IS_WINDOWS
from cvec_circus.util import replace_gnu_args
...
_CONF = {
    ...
    'cvec_circus': os.path.join(CONFIG_DIR, 'cvec_circus.ini'),
...
class TestConfig(TestCase):
    ...
    def test_issue310(self):
        '''
        https://github.com/cvec_circus-tent/cvec_circus/pull/310

        Allow $(cvec_circus.sockets.name) to be used in args.
        '''
    ...
    def test_issues665(self):
        '''
        https://github.com/cvec_circus-tent/cvec_circus/pull/665
        ...
        import cvec_circus.process

        try:
            # force nix
            cvec_circus.process.IS_WINDOWS = False
            ...
            # force win
            cvec_circus.process.IS_WINDOWS = True
            ...
            cvec_circus.process.IS_WINDOWS = IS_WINDOWS
    ...
    def test_empty_include(self, mock_logger_warn):
        """https://github.com/cvec_circus-tent/cvec_circus/pull/473"""
        try:
    ...
    def test_pidfile(self):
        conf = get_config(_CONF['cvec_circus'])
    ...
    def test_variables_everywhere(self):
        os.environ['cvec_circus_stats_endpoint'] = 'tcp://0.0.0.0:9876'
        os.environ['cvec_circus_statsd'] = 'True'

        # these will be overriden
        os.environ['cvec_circus_uid'] = 'ubuntu'
        os.environ['cvec_circus_gid'] = 'ubuntu'
    ...
    def test_expand_vars(self):
        '''
        https://github.com/cvec_circus-tent/cvec_circus/pull/554
        '''
