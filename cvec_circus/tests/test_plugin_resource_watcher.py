...
from cvec_circus.tests.support import TestCircus, async_poll_for, Process
from cvec_circus.tests.support import async_run_plugin, EasyTestSuite
from cvec_circus.plugins.resource_watcher import ResourceWatcher
...
fqn = 'cvec_circus.tests.test_plugin_resource_watcher.run_leaky'
