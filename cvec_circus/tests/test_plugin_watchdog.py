...
from cvec_circus.tests.support import TestCircus, Process, async_poll_for
from cvec_circus.tests.support import async_run_plugin as arp, EasyTestSuite
from cvec_circus.plugins.watchdog import WatchDog
...
fqn = 'cvec_circus.tests.test_plugin_watchdog.run_dummy_watchdogged'
