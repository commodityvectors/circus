...
from cvec_circus.process import RUNNING, UNEXISTING

from cvec_circus.stream import QueueStream
from cvec_circus.tests.support import TestCircus, truncate_file
from cvec_circus.tests.support import async_poll_for, EasyTestSuite
from cvec_circus.tests.support import MagicMockFuture, skipIf, IS_WINDOWS
from cvec_circus.tests.support import PYTHON
from cvec_circus.util import get_python_version, tornado_sleep
...
class TestWatcherHooks(TestCircus):
    ...
    def run_with_hooks(self, hooks, streams=False):
        ...
        return self._create_cvec_circus(dummy_process,
...
class RespawnTest(TestCircus):
    ...
    def test_not_respawning(self):
        oneshot_process = 'cvec_circus.tests.test_watcher.oneshot_process'
        testfile, arbiter = self._create_cvec_circus(oneshot_process,
