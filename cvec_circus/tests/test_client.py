...
from cvec_circus.tests.support import TestCircus, EasyTestSuite, IS_WINDOWS
...
class TestWithHook(TestCircus):
    def run_with_hooks(self, hooks):
        ...
        return self._create_cvec_circus(dummy_process, async=True,
    ...
    def test_message_id(self):
        hooks = {'before_stop': ('cvec_circus.tests.test_client.long_hook', False)}
