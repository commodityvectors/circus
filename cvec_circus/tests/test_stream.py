...
from cvec_circus.py3compat import StringIO

from cvec_circus.client import make_message
from cvec_circus.tests.support import TestCircus, async_poll_for, truncate_file
from cvec_circus.tests.support import TestCase, EasyTestSuite, skipIf, IS_WINDOWS
from cvec_circus.stream import FileStream, WatchedFileStream
from cvec_circus.stream import TimedRotatingFileStream
from cvec_circus.stream import FancyStdoutStream
...
class TestWatcher(TestCircus):
    dummy_process = 'cvec_circus.tests.test_stream.run_process'
    ...
    def test_stop_and_restart(self):
        # cf https://github.com/cvec_circus-tent/cvec_circus/issues/912
