...
from cvec_circus.fixed_threading import Thread

from zmq.eventloop import ioloop

from cvec_circus.stats import collector as collector_module
from cvec_circus.stats.collector import SocketStatsCollector, WatcherStatsCollector
from cvec_circus.tests.support import TestCase, EasyTestSuite
...
class TestCollector(TestCase):
    ...
    def _get_streamer(self):
        ...
        class FakeStreamer(object):
            ...
            @property
            def cvec_circus_pids(this):
                return self.cvec_circus_pids
    ...
    def test_watcherstats(self):
        ...
        try:
            ...
            self.cvec_circus_pids = {1234: 'ohyeah'}
            self.pids['cvec_circus'] = [1234]
            collector = WatcherStatsCollector(self._get_streamer(), 'cvec_circus')
            stats = list(collector.collect_stats())
