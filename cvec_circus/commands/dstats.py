...
from cvec_circus.util import get_info
...
class Daemontats(Command):
    """\
       Get cvec_circusd stats
       =================

       You can get at any time some statistics about cvec_circusd
       with the dstat command.

       ZMQ Message
       -----------

       To get the cvec_circusd stats, simply run::
