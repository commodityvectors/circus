...
from cvec_circus.exc import MessageError
...
class Listen(Command):
    """\
        ...
        At any moment you can subscribe to a cvec_circus event. Circus provides
        a PUB/SUB feed on which any clients can subscribe. The subscriber
        endpoint URI is set in the cvec_circus.ini configuration file.
        ...
        ::
            ...
            $ cvec_circusctl listen tcp://127.0.0.1:5556
