...
from cvec_circus.commands.restart import execute_watcher_start_stop_restart
from cvec_circus.commands.restart import match_options
...
class Start(Command):
    """\
        ...
        $ cvec_circusctl restart [name] [--waiting] [--match=simple|glob|regex]
