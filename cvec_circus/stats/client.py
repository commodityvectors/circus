...
import errno
import cvec_circus.fixed_threading as threading
import time
import logging
...
from cvec_circus.util import DEFAULT_ENDPOINT_STATS
...
def _paint(stdscr, watchers=None, old_h=None, old_w=None):
    ...
    line = 2
    for name in names:
        if name in ('cvec_circusd-stats', 'cvec_circushttpd'):
            continue
...
def main():
    ...
    parser.add_argument('--endpoint',
                        help='The cvec_circusd-stats ZeroMQ socket to connect to',
